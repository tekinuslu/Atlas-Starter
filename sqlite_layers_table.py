...
#       )
  ...
  brt = Layers(
      ...
      category='BaseMap',
      meta_name='BRT (Basisregistratie Topografie) - <a target=''_blank'' href=''https://pdok.nl''>PDOK</a>',
...
# OPEN LAYERS MAP
  osm = Layers(
      ...
      category= 'BaseMap', 
      meta_name= '<a target=''_blank'' href=''https://www.openstreetmap.org''>OSM</a> (OpenStreetMap)',
...
#
  ...
  nat = Layers(
      ...
      category='', 
      meta_name='Beschermde natuurmonumenten  - <a target=''_blank'' href=''https://pdok.nl''>PDOK</a>',
  ...
  bomen = Layers(
      ...
      category='', 
      meta_name='Bomen in Nederland  - <a target=''_blank'' href=''https://nationaalgeoregister.nl''>NGR</a>',
      meta_kind='Thema kaart',
  ...
  rce = Layers(
      ...
      category='', 
      meta_name='Rijksmonumenten - <a target=''_blank'' href=''https://nationaalgeoregister.nl''>NGR</a>',
      meta_kind='Thema kaart',
  ...
  hiden1 = Layers(
      ...
      category='', 
      meta_name='Hidden Layer - <a target=''_blank'' href=''https://mijndatalab.nl''>mijndatalab</a>',
      meta_kind='Thema kaart',
      meta_org='<a href=''https://www.pdok.nl/'' target=''_blank''>Aardgasvelden_in_productie</a>',
      meta_updated='01/01/2020',
      #meta_updated='getDate(''full'') +'' (Dagelijks)''',
      visible=False,
      opacity=0.7,
...
####
  ...
  db.session.add(rce) ; 
  db.session.add(hiden1) ; db.session.commit();
