		...
		if (lyr.get('isExternal') && lyr.get('legend_url') ) {
			...
			"&format=image/png";
				...
				linkSrc = lyr.get('legend_url'); 
                                ...
                                // ex: hidden layers
                                if(lyr.get('is_closed_dataset')){ 
				        linkSrc = lyr.get('legend_url') + '&authkey=' + lyr.get('source').params_.authkey; // ex: hidden layers
                                   }
		}
		return linkSrc;
	}
...
// debugger;
		...
		if(layer.get('isBaseLayer')){
			...
			content_baselayer += "<img src='static/images/informatie.png' height='20' width='20'/>";
			content_baselayer += "</a>";
			content_baselayer += "</td>";
			...
			content_baselayer += "<img src='static/images/transparantie.png' height='20' width='20'/>";
			content_baselayer += "</a>";
			content_baselayer += "</td>";
		...
		if(!layer.get('isBaseLayer') && name != "Marker Layer" && !basisregistratie && !luchtfotokaart){
			...
			content_thema += "<img src='static/images/legendicon.png' height='20' width='20'/>";
			content_thema += "</a>";
			content_thema += "</td>";

			content_thema += "<td class='tweede'>";
			content_thema += "<a data-tooltip='tooltip' title='Filter data' data-toggle='collapse' data-target='#"+filterID+"'>";
			//content_thema += "<img class='openDataFilter' src='images/filter.png' height='20' width='20'/>";
			content_thema += "<img class='openDataFilter' src='static/images/filter.png' height='20' width='20'/>";
			content_thema += "</a>";
			content_thema += "</td>";
			...
			content_thema += "<img src='static/images/informatie.png' height='20' width='20'/>";
			content_thema += "</a>";
			content_thema += "</td>";
			...
			content_thema += "<img src='static/images/transparantie.png' height='20' width='20'/>";
			content_thema += "</a>";
			content_thema += "</td>";
		...
		if(basisregistratie){
			...
			content_basisreg += "<img src='static/images/legendicon.png' height='20' width='20'/>";
			content_basisreg += "</a>";
			content_basisreg += "</td>";
			...
			content_basisreg += "<img src='static/images/informatie.png' height='20' width='20'/>";
			content_basisreg += "</a>";
			content_basisreg += "</td>";
			...
			content_basisreg += "<img src='static/images/transparantie.png' height='20' width='20'/>";
			content_basisreg += "</a>";
			content_basisreg += "</td>";
		...
		if(luchtfotokaart){
			...
			content_luchtfotos += "<img src='static/images/informatie.png' height='20' width='20'/>";
			content_luchtfotos += "</a>";
			content_luchtfotos += "</td>";
			...
			content_luchtfotos += "<img src='static/images/transparantie.png' height='20' width='20'/>";
			content_luchtfotos += "</a>";
			content_luchtfotos += "</td>";
	...
	var iconStyle = new ol.style.Style({
	 image: new ol.style.Icon(({
		 ...
		 anchorYUnits: 'pixels',
		 opacity: 0.75,
		 src: 'static/img/select_icoon.png'
	 }))
 	});
	...
	map.on('click', function(evt) {
		...
		layerList.forEach(function(layer, i){
			...
			// create url for getGetFeatureInfoUrl
			var layer_url = info_url_before + "&QUERY_LAYERS=" + layer.get('layer_name') ;
					 ...
					 success:function(data){
						//alert("data: " + data);
	 					data.features.map(function (v,i) {
							...
							content_popup += "<a class='accordion-toggle collapsed' data-toggle='collapse' href='#"+layer.get('filterdataid')+"'>";
							content_popup += 	"<span class='text'>"+layer.get('title')+"</span>";
							content_popup +=  "<span class='icon-caret icon-caret-right'></span></a>";
							content_popup += "<br/>";
							content_popup += "<div style='margin-top:4px;' id='"+layer.get('filterdataid')+"' class='collapse'>";
